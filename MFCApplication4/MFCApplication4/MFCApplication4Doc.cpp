...
// MFCApplication4Doc.cpp : CMFCApplication4Doc 类的实现
//
...
// CMFCApplication4Doc 构造/析构

CMFCApplication4Doc::CMFCApplication4Doc()
{
	// TODO: 在此添加一次性构造代码
	down.Format(_T("左键正被按下"));
	up.Format(_T("左键正在抬起"));
}
