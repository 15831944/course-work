...
// MFCApplication6Doc.cpp : CMFCApplication6Doc 类的实现
//
...
// CMFCApplication6Doc 构造/析构

CMFCApplication6Doc::CMFCApplication6Doc()
{
	// TODO: 在此添加一次性构造代码
	A = CRect(100, 200, 300, 300);
	B = CRect(400, 300, 600, 400);
	C = CRect(700, 400, 900, 500);
}
